...
| `L4-great-feast-label` | this session (Annunciation audit) | Liturgy on a Great Feast date must include the feast name in `liturgicalLabel`; pre-fix `getDayLabel` only handled some seasons' default labels and missed the Great Feast override entirely | **13/13 high** — every Great Feast Liturgy in 2026: Nativity, Theophany, Meeting, Annunciation, Palm Sunday (showed "Lazarus Saturday"), Pascha (showed "Great and Holy Saturday"), Ascension, Pentecost, Transfiguration, Dormition, Nativity Theotokos, Elevation | ✅ Full match |
