...
describe('API routes', () => {
  ...
  it('Liturgy — Communion Hymn comes before Communion Prayer, both before Post-Communion', async () => {
    // The cycling Troparia/Kontakia at the Communion Hymn happen WHILE the
    // clergy commune — i.e., between Pre-Communion and the Communion Prayer
    // ("I believe..." + "In the fear of God..." + "Blessed is He..."), which
    // is sung as the chalice is brought out for the faithful.
